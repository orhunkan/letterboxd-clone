...
export default function FilmHero({
  ...
  const handleWatch = () =>
    start(async () => {
      ...
      setIsWatched((v) => !v);
      if (!isWatched) setIsInWatchlist(false); // watched => remove from list
    });
  ...
  const handleWatchlist = () =>
    start(async () => {
      ...
      if (!isInWatchlist) setIsWatched(false); // added to list => not watched
    });
          ...
          <div className="flex-1 space-y-6 max-w-2xl">
            ...
            <div className="grid grid-cols-2 gap-4 max-w-md">
              ...
              >
                ...
                <span>{pending ? "Saving…" : isWatched ? "Unwatch" : "Watch"}</span>
              </Button>
